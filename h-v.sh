...
backend_docking_set(){
	...
	xrayr_file
	rulelist_file
	docker run --restart=always --name 17xrayr -d -v /usr/local/17xrayr/config.yml:/etc/XrayR/config.yml -v /usr/local/17xrayr/rulelist:/etc/XrayR/rulelist --network=host thone01/17xrayr-reality:v1
        setenforce 0
